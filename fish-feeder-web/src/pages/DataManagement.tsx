...
import { JsonDataOrganizer, SensorDataGroup } from "../utils/jsonDataOrganizer";
...
const DataManagement: React.FC = () => {
  ...
  const renderDataQuality = () => {
    ...
    const qualityClass = JsonDataOrganizer.getStatusClass(
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-sm font-semibold capitalize ${qualityClass}`}
            >
              {organizedSensorData.quality}
            </span>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">{renderDataQuality()}</div>
        ...
        {organizedSensorData && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            {renderSensorGroup(
              "Temperature Sensors",
              organizedSensorData.temperature,
              "°C",
            )}
            {renderSensorGroup(
              "Humidity Sensors",
              organizedSensorData.humidity,
              "%",
            )}
            {renderSensorGroup(
              "Electrical System",
              organizedSensorData.electrical,
              "",
            )}
            {renderSensorGroup(
              "Mechanical System",
              organizedSensorData.mechanical,
              "",
            )}
          </div>
        )}
            ...
            <div className="flex justify-between items-center">
              ...
              <span
                className={`text-sm font-semibold ${
                  organizedSensorData &&
                  JsonDataOrganizer.validateSensorData(organizedSensorData)
