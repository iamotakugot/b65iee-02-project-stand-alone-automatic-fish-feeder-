    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6 space-y-6">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        onClick={() => {
                          const currentAmount =
                            presetAmounts[
                              feedType as keyof typeof presetAmounts
                            ];
                          const newAmount = prompt(
                            `Edit ${feedType} amount (grams):`,
                            currentAmount,
                          );
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  value={actuatorUp}
                  onChange={(e) =>
                    handleTimingChange("actuator_up", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  value={actuatorDown}
                  onChange={(e) =>
                    handleTimingChange("actuator_down", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  value={augerDuration}
                  onChange={(e) =>
                    handleTimingChange("auger_duration", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleTimingChange("blower_duration", e.target.value)
                  }
                />
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-between mb-6">
          ...
          <Button size="sm" variant="bordered" onClick={fetchFeedHistory}>
            🔄 Refresh
          </Button>
        </div>
