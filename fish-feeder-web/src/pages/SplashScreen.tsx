  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white flex flex-col items-center justify-center relative overflow-hidden font-inter">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -left-1/2 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-indigo-400/30 rounded-full blur-2xl animate-ping delay-500" />
      </div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-md rounded-lg px-3 py-1 border border-orange-400/30">
              ...
              <span className="text-sm font-bold text-orange-300 tracking-wider">
                B65IEE02
              </span>
            </div>
          </motion.div>
        ...
        >
          ...
          >
            <div className="h-px bg-gradient-to-r from-transparent via-white to-transparent flex-1 max-w-24" />
            <span className="text-sm md:text-base text-gray-200 px-4 font-medium">
              using IoT
            </span>
            <div className="h-px bg-gradient-to-r from-transparent via-white to-transparent flex-1 max-w-24" />
          </motion.div>
        ...
        {showTeam && (
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-sm md:text-base font-semibold mb-4 text-gray-100">
              รายชื่อคณะผู้จัดทำ
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-3xl mx-auto">
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="text-blue-300 font-mono text-xs mb-1 font-semibold">
                    {member.id}
                  </div>
