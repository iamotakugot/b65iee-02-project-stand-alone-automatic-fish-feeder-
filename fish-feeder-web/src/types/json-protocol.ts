...
export function validateFirebaseCommand(
  command: Partial<FirebaseControlCommands>,
): boolean {
  const validKeys = [
    "led",
    "fan",
...
export function firebaseToArduinoCommand(
  firebaseData: Partial<FirebaseControlCommands>,
): string[] {
