          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Unavailable in Firebase hosting mode
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
              ...
              <p className="text-blue-600 dark:text-blue-400 text-sm mt-2">
                Camera recording and streaming are only available in local
                development mode. To use camera features:
              </p>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg">
            ...
            <p className="text-yellow-600 dark:text-yellow-400 text-sm mt-2">
              Camera features require Pi server to be running on{" "}
