...
import { FaQuestionCircle, FaTimes, FaExclamationTriangle } from 'react-icons/fa';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 border border-gray-200 dark:border-gray-700 animate-in fade-in duration-200">
        ...
        {/* Header */}
        <div className={`bg-gradient-to-r ${config.bgColor} border ${config.borderColor} rounded-t-lg p-6`}>
