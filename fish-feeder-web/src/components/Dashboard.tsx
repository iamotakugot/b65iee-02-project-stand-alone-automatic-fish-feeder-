    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div
            className={`p-4 rounded-lg ${isConnected ? "bg-green-100 border border-green-300 dark:bg-green-900 dark:border-green-700" : "bg-red-100 border border-red-300 dark:bg-red-900 dark:border-red-700"}`}
          >
            <div className="flex items-center">
          ...
          <div
            className={`p-4 rounded-lg ${sensorData ? "bg-green-100 border border-green-300 dark:bg-green-900 dark:border-green-700" : "bg-yellow-100 border border-yellow-300 dark:bg-yellow-900 dark:border-yellow-700"}`}
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {sensorData ? "มีข้อมูล" : "ไม่มีข้อมูล"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <ControlButton
              ...
              onClick={() =>
                handleAction("feed-small", () => controlFeeder("small"))
              }
            >
              อาหารน้อย (50g)
            </ControlButton>
            <ControlButton
              ...
              onClick={() =>
                handleAction("feed-medium", () => controlFeeder("medium"))
              }
            >
              อาหารปานกลาง (100g)
            </ControlButton>
            <ControlButton
              ...
              onClick={() =>
                handleAction("feed-large", () => controlFeeder("large"))
              }
            >
              อาหารมาก (200g)
            </ControlButton>
            <ControlButton
              ...
              onClick={() => {
                ...
                if (amount && !isNaN(Number(amount))) {
                  handleAction("feed-custom", () =>
                    controlFeeder(Number(amount)),
                  );
                }
              }}
            >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="flex gap-4">
              <ControlButton
                ...
                onClick={() =>
                  handleAction("blower-on", () => controlBlower("on"))
                }
              >
                เปิด
              </ControlButton>
              <ControlButton
                ...
                onClick={() =>
                  handleAction("blower-off", () => controlBlower("off"))
                }
              >
                ปิด
              </ControlButton>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="flex gap-4">
              <ControlButton
                ...
                onClick={() =>
                  handleAction("actuator-up", () => controlActuator("up"))
                }
              >
                ขึ้น
              </ControlButton>
              <ControlButton
                ...
                onClick={() =>
                  handleAction("actuator-down", () => controlActuator("down"))
                }
              >
                ลง
              </ControlButton>
              <ControlButton
                ...
                onClick={() =>
                  handleAction("actuator-stop", () => controlActuator("stop"))
                }
              >
                หยุด
              </ControlButton>
