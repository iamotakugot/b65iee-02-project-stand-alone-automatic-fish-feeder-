  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-700">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-300 mb-6">
        Real-time Firebase data inspection and debugging tools for development
        and troubleshooting.
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-3">
          ...
          <div className="text-lg font-bold text-purple-600 dark:text-purple-400">
            {rawFirebaseData?.sensors
              ? Object.keys(rawFirebaseData.sensors).length
              : 0}
          </div>
        </div>
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg p-3">
          ...
          <div className="text-sm font-bold text-orange-600 dark:text-orange-400">
            {rawFirebaseData?.timestamp
              ? new Date(rawFirebaseData.timestamp).toLocaleTimeString()
              : "—"}
          </div>
        </div>
      </div>
      ...
      {rawFirebaseData?.sensors && isExpanded && (
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {Object.entries(rawFirebaseData.sensors).map(
      ...
      {!isExpanded && (
        <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4">
          ...
          <div className="text-sm text-purple-600 dark:text-purple-400 space-y-1">
            <div>
              • Firebase connection: {rawFirebaseData ? "Active" : "Inactive"}
            </div>
