      ...
      >
        ...
        {showDetails && firebaseConnected && (
          <div className="mt-2 text-xs text-green-600 dark:text-green-400">
            ✓ Unified Protocol active | /controls & /sensors | 1-sec updates
          </div>
        )}
      </motion.div>
          ...
          <div className="mt-2">
            {piServerConnected ? (
              <div className="text-xs text-green-600 dark:text-green-400">
                ✓ Arduino Serial + Unified JSON protocol ready
              </div>
            ) : (
              <div className="text-xs text-orange-600 dark:text-orange-400">
                ⚠️ Commands queued in /controls until Pi reconnects
              </div>
            )}
          </div>
        )}
      ...
      {showDetails && (
        ...
        >
          ...
          <div className="mt-1 text-xs opacity-80">
            {firebaseConnected && piServerConnected
              ? "All unified protocol features available"
              : firebaseConnected
              ? "Web interface active, commands queued in /controls"
