...
import { FaTimes, FaCheck, FaExclamationCircle, FaInfoCircle } from "react-icons/fa";
...
const NotificationToast: React.FC<NotificationToastProps> = ({
  ...
  const colorClasses = {
    success: {
      ...
      close: 'text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-200'
    },
    error: {
      ...
      close: 'text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-200'
    },
    info: {
      ...
      close: 'text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200'
    },
    warning: {
      ...
      close: 'text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-200'
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* Message */}
      <div className={`${colors.text} flex-1 text-sm font-medium leading-relaxed`}>
        {message}
      </div>
