...
const QuickAccessPanel: React.FC = () => {
  ...
  const quickFeed = async (amount: number, type: string) => {
    ...
    try {
      ...
      const success = await controlFeeder(
        preset as "small" | "medium" | "large",
      );
  ...
  const emergencyStop = async () => {
    ...
    // Log emergency stop
    logger.buttonPress("EMERGENCY_STOP", "QuickAccessPanel", {
    ...
    try {
      ...
      logger.info("EMERGENCY", "ALL_MOTORS_STOPPED", {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 max-w-md mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 text-center">
          ...
          <div className="font-bold text-blue-600">{weight.toFixed(0)}g</div>
        </div>
      </div>
